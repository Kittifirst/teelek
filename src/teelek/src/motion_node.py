...
class MotionNode(Node):
    def __init__(self):
        ...
        self.error_distance_tolerance = 0.03 # 3 cm
        self.error_angle_tolerance = math.radians(2.5) 
        
        kf = 1023.0 / 85.0
        self.pids = [
            PIDF(min_val=-1023.0, max_val=1023.0, Kp=10.0, Ki=2.0, Kd=0.4, Kf=kf,
        ...
        self.done_pub = self.create_publisher(Bool, "/teelek/move_done", 10)
