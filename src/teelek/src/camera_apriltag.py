...
class Camera_apriltag(Node):
    ...
    def __init__(self):
        ...
        self.alpha_y = 0.85 # แกน Y (Side) ให้ Filter หนักขึ้นเพื่อลดการ Swing
        self.alpha_yaw = 0.7
    ...
    def draw_ui(self, frame, tag, x, y, yaw, fps):
        ...
        if tag is not None:
            ...
            cv2.putText(frame, f"Dist X: {x:.3f} m", (30, 50), 2, 0.7, (0, 255, 0), 2)
            cv2.putText(frame, f"Dist Y: {y:.3f} m", (30, 85), 2, 0.7, (0, 255, 0), 2)
